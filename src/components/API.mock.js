const recipeNotFoundText = "Recipe not found!";
const randomRecipeAPI = `https://www.themealdb.com/api/json/v1/1/random.php`;
const recipeWithoutVideoAPI =
  "https://www.themealdb.com/api/json/v1/1/search.php?s=Fruit%20and%20Cream%20Cheese%20Breakfast%20Pastries";
const searchRecipeAPI = (value) =>
  `https://www.themealdb.com/api/json/v1/1/search.php?s=${value}`;
const APIResponse = (video) => ({
  idMeal: "52874",
...
const randomMockWithVideo = APIResponse(
  "https://www.youtube.com/watch?v=nMyBC9staMU"
);

const randomMockWithOutVideo = APIResponse("");
export {
